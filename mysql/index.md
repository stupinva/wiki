...
Если в базах данных создаются таблицы с суффиксами вида `_ГГГГММ` и/или `_ГГГГММДД`, то оценить объём данных в гигабайтах за прошлый (полный) месяц в таких таблицах каждой из баз данных можно с помощью следующего запроса:
