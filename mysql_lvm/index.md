...
Для автоматизации резервного копирования с помощью мгновенных снимков я написал скрипт [[lvbackup.sh]], функционально аналогичный скрипту `xtrabackup2.sh`, описанному в статье [[mysql_periodic_xtrabackup|Периодическое резервное копирование MySQL с помощью xtrabackup]] в разделе [[mysql_periodic_xtrabackup/#index7h2|Скрипт резервного копирования]]. В отличие от того скрипта, пригодного для резервного копирования баз данных с таблицами InnoDB, этот скрипт пригоден для резервного копирования баз данных с таблицами любого формата, в том числе таблиц TokuDB.
