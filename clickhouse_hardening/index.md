...
* Настройка пользователей: Настройка защищённых пользователей, ролей и прав с помощью конфигурации или SQL-запросов.
* Сетевые настройки пользователя: Ограничение подключений по имени узла или IP-адресу.
