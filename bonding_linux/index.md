...
Теперь виртуальный коммутатор запомнил конфигурацию, которую нужно применять к сетевым интерфейсам виртуальных машин. Чтобы KVM не пытался снова добавить эти интерфейсы напрямую в коммутатор, их конфигруацию нужно привести к следующему виду:
