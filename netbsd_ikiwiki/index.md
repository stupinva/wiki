...
* добавляет на страницу поля по 10 процентов слева и справа, а тажке фоновую картинку,
...
![Дополнительные конопки и список вложений](attachments2.png)
...
Теперь можно включить в файле конфигурации `ikiwiki.setup` использование git:
