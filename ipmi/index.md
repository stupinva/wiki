...
Вся информация, которую удалось найти, сведена в таблицу ниже:

|Номер|Аутентификация|Шифрование|Целостность|
|:---:|:------------:|:--------:|:---------:|
|  0  |              |          |           |
|  1  |      X       |          |           |
|  2  |      X       |          |     X     |
...
Каждая букава в строчке соответствует сочетанию алгоритма и максимального уровня привилегий пользователя, сочетание которых разрешено использовать. Таблица соответствия букв уровню привилегий приведена ниже:
...
Онако выяснить, какой символ по счёту за какой из комплектов алгоритмов отвечает, не удалось. В некоторых источниках написано, что каждый символ соответствует алгоритму с 1 по 15, но в списке поддерживаемых алгоритмов встречаются и номера больше 15. Указание более 15 символов при этом приводит к выводу сообщения об ошибке.
