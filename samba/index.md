...
Для печати на принтер `Kyocera Ecosys M2040dn` могут потребоваться драйверы, которых нет в репозиториях операционной системы. Их можно найти на [сайте производителя](https://www.kyoceradocumentsolutions.us/en/support/downloads.name-L3VzL2VuL21mcC9FQ09TWVNNMjA0MERO.html#tab=driver).
...
3. выбрать пункт "Windows Printer via SAMBA",
4. ввести ссылку к принтеру "smb://stupin_va:P4$$w0rd@domain/printserver.domain.tld/KM2040dn%28magi%29",
5. в текстовое поля "Название" вводим название принтера, например, magi,
6. в текстовое поле "Описание" вводим произвольный текст, поясняющий, какой именно принтер имеется в виду, например, название модели принтера Kyocera ECOSYS M2040dn,
7. выбираем в выпадающем списке "Создать" производителя принтера - "kyocera",
8. нажимаем кнопку "Продолжить",
9. в поле "Модель" выбираем модель "Kyocera ECOSYS M2040dn",
10. нажимаем кнопку "Добавить принтер".
